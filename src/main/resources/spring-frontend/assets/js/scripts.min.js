                    ...
                    $('.form_search').on('submit', function (e) {
                        ...
                        if (pageSearch) {
                            function getData(address, data) {
                                $.ajax({
                                    url: address,  // 'https://virtserver.swaggerhub.com/lunpully/bookshop/1.0.0' +
                                    type: 'GET',
                                    dataType: 'json',
                                    data: data,
                                    ...
                                    offset: function () {
                                        ...
                                        if(oldOffset < 1) {
                                            ...
                                            $this.data('refreshoffset',
                                                ++oldOffset - $this.data('refreshlimit'));
                                        }
                ...
                init: function () {
                    ...
                    $('.Comments-addComment form').on('submit', function (e) {
                        ...
                        if (!error) {
                            ...
                            location.reload(); // добавил обновление страницы по клику т.к. не обновлялась сама
                        }
                    });
                                ...
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        function sendData(address) {
                                            getData(address, {
                                                offset: function () {
                                                    var oldOffset = $(slick.$slider).data('loadoffset');  //загружаем офсет
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            ...
                                            case'popular':
                                                ...
                                                break;
                                            case'author':
                                                sendData('/books/author/' + $(slick.$slider).data('authorid'))
                                                break;
                                        }
                                    }
                                }
